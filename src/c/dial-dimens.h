...
/* --- Hands --- */
    ...
    #define DIMEN_SECOND_STROKE_WIDTH 5
    #define DIMEN_SECOND_TAIL_LENGTH -8
    #define DIMEN_SECOND_BULB_RADIUS 0
    #define DIMEN_SECOND_DOT_RADIUS 6
#elif PBL_DISPLAY_WIDTH >= 200
    #define DIMEN_HOUR_STROKE_WIDTH 7
    ...
    #define DIMEN_SECOND_TAIL_LENGTH -8
    #define DIMEN_SECOND_BULB_RADIUS 0
    #define DIMEN_SECOND_DOT_RADIUS 5
#else
    ...
    #define DIMEN_SECOND_STROKE_WIDTH 3
    #define DIMEN_SECOND_TAIL_LENGTH -6
    #define DIMEN_SECOND_BULB_RADIUS 0
    #define DIMEN_SECOND_DOT_RADIUS 4
#endif
